  ...
  return (
    <div className="bg-white shadow-lg p-6 rounded-lg text-center max-w-md mx-auto">
      <h2 className="font-montserrat text-2xl font-bold mb-4">
        Simulador de ganhos com o sistema de indicações
      </h2>
      <p className="font-open-sans text-lg text-gray-700 mb-4">
        Ajuste o controle deslizante para ver quanto você pode ganhar com suas
        indicações.
      </p>
      <input
        type="range"
      ...
      <p className="italic text-gray-400 mt-3 text-xs">
        Disclaimer: exemplos apenas; ganhos não são garantidos. Os resultados
        reais variam com base no esforço.
      </p>
    </div>
  );
};
